...
public class AdvancedPieces extends JPanel {
    ...
    PurplePiece question2 = new PurplePiece(4);
    PurplePiece question3 = new PurplePiece(4);
    PurplePiece question4 = new PurplePiece(4);

    public AdvancedPieces() {
        PIECE_WIDTH = 90;
        PIECE_HEIGHT = 90;
    ...
    public void paintAdvanced(Graphics g) {
        paintComponent(g);
    }
    ...
    public void paintComponent(Graphics g){
        ...
        g.drawImage(laser.getImage(), 350, 110, this);
        g.drawImage(topLeft.getImage(), 110, 470, this);
        g.drawImage(target.getImage(), 470, 230, this);
        g.drawImage(yellow.getImage(), 470, 350, this);
        g.drawImage(question1.getImage(), 725, 290, this);
